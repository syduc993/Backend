...
def get_my_zip_file(request):
    try:
        ...
        FileSystemStorage(location="home/syduc993/Backend/social/files_exel").save(name_xlsx, in_memory_file_obj)
        folder_path ='my_zip_'+str(random.randint(1, 99999))
        folder_path1 = 'home/syduc993/Backend/social/upload/'+folder_path+'/'
        os.mkdir(folder_path1)

        Tach_file_tang_truong(name_xlsx,folder_path1)

        shutil.make_archive (folder_path, 'zip', 'home/syduc993/Backend/social/upload/'+folder_path+'/')
        shutil.move(folder_path+'.zip', 'home/syduc993/Backend/social/upload/')
        shutil.rmtree('home/syduc993/Backend/social/upload/' + folder_path)
        os.remove('home/syduc993/Backend/social/files_exel/' + name_xlsx)
...
def get_file_calendar(request):
    try:
        ...
        folder_path ='my_zip_'+str(random.randint(1, 99999))
        folder_path1 = 'home/syduc993/Backend/social/upload/'+folder_path+'/'
        folder_path2 = 'home/syduc993/Backend/social/upload/'
        #os.mkdir(folder_path1)
...
def delete_my_zip_file(request):
    ...
    file_path = 'home/syduc993/Backend/social/upload/'+ name
    os.remove(file_path)
    foderlink = 'home/syduc993/Backend/social/upload'
    for i in os.listdir(foderlink):
        ...
        try:
            ...
            os.remove(t)
    foderlink = 'home/syduc993/Backend/social/files_exel'
    for i in os.listdir(foderlink):
        t=os.path.join(foderlink,i)
        try:
            shutil.rmtree(t)
